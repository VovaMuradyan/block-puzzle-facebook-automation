...
async function main() {
  const unzippedDir = 'C:\\Users\\Vov\\Downloads\\block puzzle';
  ...
  const concatListPath = path.join(__dirname, '..', 'temp_concat_list_puzzle.txt');
  ...
  const outputFileName = 'block_puzzle_intro_scene_40s.mp4';
